...
Il mio focus principale è sulle operazioni di **Blue Teaming, SOC Analysis e Incident Response**, mantenendo però una forte consapevolezza delle tattiche avversarie (Red Teaming) e delle basi architetturali di rete.
...
* **Custom Scripts:** Sviluppo di script operativi, come `triage_script.py` per la scansione di file JSON e l'inoltro di alert via mail.
